...
$client_name = new admin_setting_configtext(
...
$client_password = new admin_setting_configpasswordunmask(
...
$client_region = new admin_setting_configselect(
...
$client_curriculum = new admin_setting_configselect(
...
$debug_enabled = new admin_setting_configselect(
...
if ($id == 'filtersettingsiyavula') { // Only if the current page is the filter siyavula settings
        ...
        if (!empty($tokenresponse)) {
                $token_get = new admin_setting_description(
        ...
        if (!empty($get_users) && !empty($tokenresponse)) {
                ...
                $list_users = new admin_setting_configselect(
